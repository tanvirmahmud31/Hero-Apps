            ...
            <div className='flex justify-between items-center flex-wrap gap-3 mt-4'>
                ...
                <div className="relative w-full sm:w-80">
                    ...
                    <input
                        ...
                        className="border border-gray-300 rounded-lg pl-10 pr-4 py-2 mb-2 w-full focus:outline-none focus:border-purple-600"
                    />
                </div>
                ...
                searchedApp.length > 0 ? (
                    ...
                    <>
                        <div className="text-center w-full mt-10">
                            <h2 className="text-2xl font-semibold text-gray-600">No Apps Found 😢</h2>
